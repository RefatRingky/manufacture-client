    ...
    return (
        <div className="drawer drawer-end">
            ...
            <div className="drawer-content flex flex-col">
                <div className="w-full navbar bg-black text-orange-500 sticky top-0 z-10">
                    ...
                    <div className="flex-1 px-2 mx-2"><Link to='/' >Rinrav's Refrigator House</Link></div>
                    ...
                    <div className="flex-none hidden lg:block">
                        <ul className="menu menu-horizontal text-orange-500">
