...
const Login = () => {
    ...
    return (
        <div className='flex h-screen justify-center items-center my-10 bg-black'>
            <div className="card w-96 my-10 bg-orange-400 shadow-xl">
                <div className="card-body">
                    ...
                    <p><small>New to Digitaz? <Link className='text-white' to="/regester">Create New Account</Link></small></p>
